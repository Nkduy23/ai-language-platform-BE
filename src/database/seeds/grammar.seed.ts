...
KHÔNG dùng đảo ngữ này cho câu điều kiện loại 1 (không có "Should" đặc biệt) — chỉ áp dụng cho Type 2, Type 3, và câu với "should" mang tính giả định.`,
    ...
    // ── Bổ sung các điểm ngữ pháp thực dụng ─────────────────────────────────────
    {
      id: "en-grammar-a1-06",
      title: "There is / There are",
      level: "A1",
      orderIndex: 6,
      content: `# There is / There are
...
- There **isn't** any milk left. (phủ định)
- **Is there** a bank near here? (nghi vấn)

## Lưu ý
"There" ở đây không có nghĩa "ở đó" — chỉ dùng để giới thiệu sự tồn tại của thứ gì đó, khác với "here/there" chỉ nơi chốn.`,
    },
    {
      id: "en-grammar-a2-04",
      title: "Giới từ chỉ thời gian và nơi chốn (in/on/at)",
      level: "A2",
      orderIndex: 4,
      content: `# Giới từ IN / ON / AT

## Thời gian
| Giới từ | Dùng cho | Ví dụ |
|---|---|---|
| in | tháng, năm, mùa, buổi (sáng/chiều/tối) | in July, in 2024, in the morning |
| on | ngày, thứ trong tuần | on Monday, on my birthday |
| at | giờ cụ thể, một số cụm cố định | at 7pm, at night, at the weekend |

## Nơi chốn
| Giới từ | Dùng cho | Ví dụ |
|---|---|---|
| in | không gian kín/lớn (thành phố, nước, phòng) | in Hanoi, in the room |
| on | bề mặt | on the table, on the wall |
| at | địa điểm cụ thể | at the door, at school |

## Mẹo ghi nhớ
in (trong) → on (trên bề mặt) → at (điểm cụ thể) — đi từ KHÔNG GIAN LỚN đến ĐIỂM NHỎ.`,
    },
    {
      id: "en-grammar-a2-05",
      title: "Động từ khiếm khuyết (Modal Verbs): can, must, should",
      level: "A2",
      orderIndex: 5,
      content: `# Modal Verbs: can, must, should

## can — khả năng, sự cho phép
> I **can** swim. (khả năng)
> You **can** leave now. (cho phép)

## must — bắt buộc (mạnh, thường từ người nói)
> You **must** wear a seatbelt. (luật/quy định)
> mustn't = cấm: You **mustn't** smoke here.

## should — lời khuyên
> You **should** see a doctor. (khuyên nên làm)
> shouldn't = khuyên không nên: You **shouldn't** eat too much sugar.

## Lưu ý quan trọng
- Modal verb + V (nguyên mẫu, KHÔNG thêm to, KHÔNG chia theo ngôi)
- ❌ He cans swim. / ✅ He can swim.
- must (bắt buộc từ người nói) khác have to (bắt buộc từ hoàn cảnh/luật bên ngoài)`,
    },
    {
      id: "en-grammar-b1-03",
      ...
      level: "B1",
      orderIndex: 3,
      content: `# Gerund (V-ing) vs Infinitive (to V)
...
## Động từ + to V
want, need, decide, hope, plan, promise, agree...
> I **want to travel** to Japan.
> She **decided to study** medicine.

## Động từ + cả 2 nhưng đổi nghĩa
| Động từ | + V-ing | + to V |
|---|---|---|
| remember | nhớ đã làm (quá khứ) | nhớ để làm (tương lai) |
| stop | dừng hẳn việc đang làm | dừng lại để làm việc khác |
| try | thử làm (thử nghiệm) | cố gắng làm (nỗ lực) |

> I remember **locking** the door. (tôi nhớ đã khoá rồi)
> I remember **to lock** the door. (tôi nhớ [phải] khoá cửa — nhắc nhở)`,
    },
    {
      id: "en-grammar-b1-04",
      ...
      level: "B1",
      orderIndex: 4,
      content: `# Used to / Be used to / Get used to

## used to + V — thói quen/tình trạng TRONG QUÁ KHỨ, giờ không còn nữa
> I **used to live** in Da Nang. (trước đây tôi sống ở Đà Nẵng, giờ không còn)
> She **didn't use to like** coffee. (phủ định: bỏ "d" ở "use")

## be used to + V-ing/danh từ — ĐÃ QUEN với điều gì (hiện tại)
> I **am used to working** at night. (tôi đã quen làm việc ban đêm)
> He **is used to** the noise. (anh ấy đã quen với tiếng ồn)

## get used to + V-ing/danh từ — QUÁ TRÌNH làm quen dần
> It took me a while to **get used to living** abroad.

## So sánh nhanh
| Cấu trúc | Ý nghĩa |
|---|---|
| used to + V | Thói quen quá khứ, đã kết thúc |
| be used to + V-ing | Đã quen (trạng thái hiện tại) |
| get used to + V-ing | Đang/dần quen (quá trình) |`,
    },
  ];
...
Đây là 1 trong những điểm ngữ pháp khó nhất với người học trung cấp — cần luyện nghe/đọc nhiều để cảm nhận tự nhiên hơn là học thuộc quy tắc.`,
    ...
    {
      id: "zh-grammar-a1-03",
      title: "Thể tiếp diễn với 在...呢",
      level: "A1",
      orderIndex: 7,
      content: `# Thể tiếp diễn với 在 (zài) ...呢 (ne)
...
## Lưu ý
呢 ở cuối câu không bắt buộc nhưng thường dùng để nhấn mạnh tính "đang diễn ra", giọng văn nói tự nhiên hơn.`,
    },
    {
      id: "zh-grammar-a2-03",
      title: "想 / 要 / 可以 — muốn, cần, có thể",
      level: "A2",
      orderIndex: 5,
      content: `# 想 (xiǎng) / 要 (yào) / 可以 (kěyǐ)

## 想 — muốn (mong muốn nhẹ nhàng)
> 我想去中国。(Wǒ xiǎng qù zhōngguó.) — Tôi muốn đi Trung Quốc.

## 要 — muốn/cần (mạnh hơn 想, đôi khi mang tính quyết định)
> 我要一杯咖啡。(Wǒ yào yì bēi kāfēi.) — Tôi muốn (gọi) một ly cà phê.

## 可以 — có thể, được phép
> 我可以进来吗？(Wǒ kěyǐ jìnlái ma?) — Tôi có thể vào được không?
> 这里可以拍照。(Zhèlǐ kěyǐ pāizhào.) — Ở đây được phép chụp ảnh.

## So sánh nhanh
| Từ | Ý nghĩa | Sắc thái |
|---|---|---|
| 想 | muốn | Nhẹ nhàng, mong muốn cá nhân |
| 要 | muốn/cần | Mạnh hơn, dùng khi gọi món/yêu cầu |
| 可以 | có thể/được phép | Khả năng hoặc sự cho phép |`,
    },
    {
      id: "zh-grammar-b1-03",
      title: "Cấu trúc 从...到 (cóng...dào) — Từ...đến",
      level: "B1",
      orderIndex: 7,
      content: `# Cấu trúc 从 (cóng) ...到 (dào)

## Dùng cho thời gian
> 我从九点到五点工作。(Wǒ cóng jiǔ diǎn dào wǔ diǎn gōngzuò.) — Tôi làm việc từ 9 giờ đến 5 giờ.

## Dùng cho địa điểm
> 从河内到胡志明市有多远？(Cóng Hénèi dào Húzhìmíng Shì yǒu duō yuǎn?) — Từ Hà Nội đến TP.HCM bao xa?

## Dùng cho phạm vi trừu tượng
> 从小到大，他一直很努力。(Cóng xiǎo dào dà, tā yìzhí hěn nǔlì.) — Từ nhỏ đến lớn, anh ấy luôn chăm chỉ.

## Lưu ý
从 luôn đứng trước điểm BẮT ĐẦU, 到 luôn đứng trước điểm KẾT THÚC — không thể đảo ngược thứ tự.`,
    },
    {
      id: "zh-grammar-b1-04",
      title: "Cấu trúc 太...了 (tài...le) — Quá...",
      level: "B1",
      orderIndex: 8,
      content: `# Cấu trúc 太 (tài) ...了 (le)

## Cấu trúc
\`\`\`
太 + Tính từ + 了
\`\`\`
Diễn tả mức độ CAO, thường mang sắc thái cảm thán (quá, rất).

## Ví dụ
- 这个太贵了！(Zhège tài guì le!) — Cái này quá đắt!
- 今天太热了。(Jīntiān tài rè le.) — Hôm nay quá nóng.
- 你太好了！(Nǐ tài hǎo le!) — Bạn tốt quá!

## Phân biệt với 很 (hěn)
- 很 (rất): mức độ bình thường, trung tính — 很好 (rất tốt)
- 太...了 (quá): mức độ cao, thường có sắc thái cảm thán hoặc phàn nàn — 太贵了 (quá đắt, hàm ý phàn nàn)`,
    },
  ];
...
| みたいだ | Quan sát/cảm nhận trực tiếp | Thân mật, văn nói |`,
    ...
    {
      id: "ja-grammar-a2-03",
      title: "Mong muốn với たい (tai-form)",
      level: "A2",
      orderIndex: 5,
      content: `# Thể たい (tai-form) — muốn làm gì
...
## Ví dụ
- 日本に行きたいです。(Nihon ni ikitai desu.) — Tôi muốn đi Nhật.
- 何を食べたいですか？(Nani o tabetai desu ka?) — Bạn muốn ăn gì?
- 水が飲みたいです。(Mizu ga nomitai desu.) — Tôi muốn uống nước.

## Lưu ý về trợ từ
Khi có tân ngữ, trợ từ có thể đổi từ を sang が (cả 2 đều được chấp nhận, が nhấn mạnh mong muốn hơn):
- 水を飲みたいです. / 水が飲みたいです. — đều đúng
...
- 行きたくないです。(Tôi không muốn đi.)`,
    ...
    {
      id: "ja-grammar-b1-03",
      title: "から và ので — vì, bởi vì",
      level: "B1",
      orderIndex: 7,
      content: `# から (kara) và ので (node) — chỉ nguyên nhân
...
## Ví dụ
- 疲れたから、休みます。(Tsukareta kara, yasumimasu.) — Vì mệt nên tôi nghỉ.
- 雨が降っているので、傘を持って行きます。(Vì trời đang mưa nên tôi mang theo ô.)

## Phân biệt から vs ので
| から | ので |
|---|---|
| Chủ quan, nhấn mạnh lý do cá nhân | Khách quan, lịch sự hơn |
| Dùng được trong câu mệnh lệnh/mời | Ít dùng trong câu mệnh lệnh trực tiếp |
| 疲れたから、寝てください。(ít tự nhiên) | 疲れたので、寝てください。(tự nhiên hơn) |

## Lưu ý
Trong văn viết trang trọng/xin phép, ので được ưa dùng hơn vì tạo cảm giác khách quan, ít áp đặt.`,
    },
    {
      id: "ja-grammar-b1-04",
      title: "Cấu trúc なる — trở nên",
      level: "B1",
      orderIndex: 8,
      content: `# Cấu trúc なる (naru) — trở nên

## Với tính từ đuôi い → く + なる
> 寒くなりました。(Samuku narimashita.) — Trời đã trở lạnh.
> 忙しくなります。(Sẽ trở nên bận rộn.)

## Với tính từ đuôi な → に + なる
> 元気になりました。(Genki ni narimashita.) — Đã khoẻ lại rồi.
> 静かになりました。(Đã trở nên yên tĩnh.)

## Với danh từ → に + なる
> 先生になりたいです。(Sensei ni naritai desu.) — Tôi muốn trở thành giáo viên.
> 春になりました。(Đã sang xuân rồi.)

## Lưu ý
なる diễn tả sự THAY ĐỔI TỰ NHIÊN theo thời gian, khác với する (làm cho trở nên, có chủ ý tác động).`,
    },
    {
      id: "ja-grammar-b1-05",
      title: "Cấu trúc ながら — vừa...vừa...",
      level: "B1",
      orderIndex: 9,
      content: `# Cấu trúc ながら (nagara) — vừa...vừa...

## Cấu trúc
\`\`\`
Động từ (bỏ ます) + ながら、Động từ chính
\`\`\`
Diễn tả 2 hành động xảy ra ĐỒNG THỜI, do CÙNG 1 người thực hiện.

## Ví dụ
- 音楽を聞きながら、勉強します。(Ongaku o kikinagara, benkyou shimasu.) — Tôi vừa nghe nhạc vừa học.
- テレビを見ながら、ご飯を食べます。(Vừa xem TV vừa ăn cơm.)

## Lưu ý quan trọng
- Hành động chính (quan trọng hơn) đặt ở MỆNH ĐỀ SAU
- 2 hành động phải do CÙNG 1 chủ thể thực hiện — khác với khi 2 người khác nhau làm 2 việc cùng lúc (dùng cấu trúc khác như 間に)

## So sánh
❌ 母が料理をしながら、私は勉強します。(sai — 2 chủ thể khác nhau)
✅ 母は料理をしながら、鼻歌を歌います。(đúng — mẹ vừa nấu ăn vừa hát khe khẽ, cùng 1 người)`,
    },
  ];
